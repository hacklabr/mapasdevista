<?php //global $post; ?>
<div id="balloon_<?php the_ID(); ?>" class="result clearfix balloon">
    <div class="pin"><?php the_pin(); ?></div>
    <div class="content">
        <p class="metadata date bottom"><?php the_time( get_option('date_format') ); ?></p>
        <h1 class="bottom"><a class="js-link-to-post" id="post-link-<?php the_ID(); ?>" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h1>
